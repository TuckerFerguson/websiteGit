	...
	<div class="lefty">
		<table style="width:100%">
			<td><a href="newslink.php">
				<img src="basketball.gif" alt="Basketball"></a></td>
			</table>
			<p>Small description of this basketball event</p>
			<hr>
		<table style="width:100%">
			<td><a href="newslink.php">
		...
		<table style="width:100%">
			<td><a href="newslink.php">
			<img src="football.gif" alt="Football"></a></td>
			</table>
			<p>Small description of this football event</p>
			<hr>
			<table style="width:100%">
			<td><a href="newslink.php">
			<img src="soccer.gif" alt="Football"></a></td>
			</table>
			<p>Small description of this soccer event</p>
			<hr>
	</div>
	<div class="news">
	<div><img src="logo.png" alt="SportEmpire Logo">
			<h1>Thrilling Game Leads to OT</h1>
			<ul>
				<li><a href="login.php">Member Login</a></li>
				<li><a href="register.php">New to SportEmpire?</a></li>
				<li><a href="newslink.php">Sports Forum</a></li>
			</ul>
			</div>
		<ul>
			<hr>
			...
			<hr>
			<h2>Running out of food items</h2>
